...
RUN jupyter labextension install @jupyterlab/jupyterlab-plotly @jupyterlab/launcher-extension @jupyter-widgets/jupyterlab-manager @jupyterlab/hub-extension
